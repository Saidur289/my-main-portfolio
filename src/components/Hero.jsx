    ...
    return (
        <div className='bg-black text-white text-center py-16'>
            ...
            <div className='mt-8 space-x-4'>
                <button className='bg-gradient-to-r from-green-400 to-blue-500 text-white hidden md:inline transform transition-transform duration-300 px-4 py-2 rounded-full'>Connect With Me</button>
                <button className='bg-gradient-to-r from-pink-500 to-yellow-500 text-white hidden md:inline transform transition-transform duration-300 px-4 py-2 rounded-full'>Resume</button>
